...
public class MainJFrame  extends javax.swing.JFrame implements Reporter,CompleteListener{
    ...
    private void initComponents() {
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder("协同演化方式"));
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("个体迁徙方式"));
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder("个体学习方式"));
    ...
    private void addComponentsListener(){
    	jTextFieldGridLength.addFocusListener(new FocusAdapter() {
    		...
    		public void focusLost(FocusEvent e) {
    			...
    			if( i <= 0){
    				JOptionPane.showMessageDialog(MainJFrame.this, "网格边长必须是一个有效的正整数");
    ...
    private void setLearningPatternText(JRadioButton radioButton){
    	if( radioButton.equals(jRadioButtonMaxPayoffLearning)){
			...
			jTextFieldLearningPattern.setText("从直接邻居学习策略，个体i随机选择一个邻居j后，按照下式决定是否学习该邻居，"
    ...
    private void setMigratePatternText(JRadioButton radioButton){
    	if(radioButton.equals(jRadioButtonMigrationNone)){
			...
			jTextFieldMigrationPattern.setText("个体个体i所在位置x为xk在一阶邻居中随机选取一个空位xl，"
			...
			jTextFieldMigrationPattern.setText("个体统计周围邻居背叛者的数量nd，以nd/8的概率迁徙到空位上");
		}
    }
    ...
    class WorkThread extends Thread{
    	...
    	public WorkThread(int L, float d0, float R, float S,  float T, float P,
    			float pi, float qi, LearningPattern learningPattern, MigrationPattern imigratePattern,
    			StrategyPattern strategyPattern, String filepath, boolean recordSnapShoot,
    			int maxTurn, Reporter reporter,CompleteListener completeListener){
    		spdg = new SpatialPDGame(recordSnapShoot, reporter);
    		spdg.initSpatialPDGame(L, d0, R, S, T, P, pi, qi,1.0f, learningPattern, imigratePattern, strategyPattern, NeighbourCoverage.Classic);
