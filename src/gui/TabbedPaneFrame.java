...
public class TabbedPaneFrame extends JFrame {
    ...
    public TabbedPaneFrame(String imagePath) {
        ...
        ImageIcon icon = new ImageIcon(imagePath+"\\yellow-ball.gif");
    ...
    private void loadTab(int n) {
        ...
        ImageIcon planetIcon = new ImageIcon(imagePath+"\\"+title + ".gif");
        tabbedPane.setComponentAt(n, new JLabel(planetIcon));

        // indicate that this tab has been visited--just for fun

        tabbedPane.setIconAt(n, new ImageIcon(imagePath+"\\"+"red-ball.gif"));
    }
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                JFrame frame = new TabbedPaneFrame("C:\\Users\\hyx\\Desktop\\tabbedPane");
